...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (clientName && email && EmailValidation(email) && messages) {
      axios.post("https://getform.io/f/1ad83ec8-21b8-4c24-a949-9eedf6b4e39e", {
        name: clientName,
        email: email,
        message: messages,
      });
    ...
    <div className="w-full">
      ...
      <div className="p-6 w-full flex flex-col md:flex-row justify-between gap-4 md:gap-10 lgl:gap-20">
        <div className="w-full lgl:w-1/2">
          <p className="flex gap-6 justify-between w-full text-lg text-[#ccc] py-4 border-b-[1px] border-b-zinc-800">
            ...
            1-196 Akumalla(v), Sanjamalla (m) Nandyal(d) Andhra Pradesh
          </p>
      ...
      <div className="w-full mt-10">
        ...
        {seuccessMsg ? (
          ...
          <form
            id="form"
            action="https://getform.io/f/1ad83ec8-21b8-4c24-a949-9eedf6b4e39e"
            method="POST"
