      ...
      <div className="col-span-9 md:col-span-4">
        ...
        <div className="py-4">
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">FrontEnd Development</p>
         ...
         <div className="py-3 border-b-[1px] border-zinc-800">
          <p className="text-base text-textColor -mb-1.5">Database</p>
          <span className="w-full bg-zinc-600 h-1 inline-flex relative">
          ...
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">Backend Development</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
